...
export function createAIProvider(options?: {
  ...
  const fallbackType = (options?.fallbackProvider || process.env.AI_FALLBACK_PROVIDER || '').toLowerCase();
